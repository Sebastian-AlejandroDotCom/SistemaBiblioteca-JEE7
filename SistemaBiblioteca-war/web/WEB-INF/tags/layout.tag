    ...
    <body>
        <section id="container" class="">
            ...
            <header id="header" class="header dark-bg">
                <!--logo start-->
                <a href="inicio" class="logo"><i class="fas fa-university"></i> Sistema <span class="lite">Biblioteca</span></a>
                <!--logo end-->
            </header>
                ...
                <div id="sidebar" class="nav-collapse ">
                    ...
                    <ul class="sidebar-menu">
                        <li class="sub-menu">
                            ...
                            <ul class="sub">
                                <li><a class="" href="libros"><i class="fas fa-angle-right"></i>Libros</a></li>
                                <li><a class="" href="autores"><i class="fas fa-angle-right"></i>Autor</a></li>
                                <li><a class="" href="editoriales"><i class="fas fa-angle-right"></i>Editorial</a></li>
                                <li><a class="" href="categorias"><i class="fas fa-angle-right"></i>Categoría</a></li>
                                <li><a class="" href="idiomas"><i class="fas fa-angle-right"></i>Idioma</a></li>
                                <li><a class="" href="estados"><i class="fas fa-angle-right"></i>Estado</a></li>
                            </ul>
                        </li>
                        <li>
                            <a class="" href="#">
