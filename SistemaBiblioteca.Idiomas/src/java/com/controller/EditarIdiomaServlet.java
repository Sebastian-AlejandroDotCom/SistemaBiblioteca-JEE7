 ...
 * @author sebastian
 */
@WebServlet(name = "EditarIdiomaServlet", urlPatterns = {"/editarIdioma"})
public class EditarIdiomaServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        String idIdioma = request.getParameter("editId");
        Idioma idioma = idiomaFacade.find(Integer.parseInt(idIdioma));

        request.setAttribute("idioma", idioma);
        request.getRequestDispatcher("/editarIdioma.jsp").forward(request, response);
    }
