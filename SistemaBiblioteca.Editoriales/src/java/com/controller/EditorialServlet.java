...
public class EditorialServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        request.setAttribute("editoriales", editorialFacade.findAll());
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        String idEditorial = request.getParameter("searchId");
        
        if (idEditorial == null) {
            processRequest(request, response);
        } else {
            request.setAttribute("editoriales", editorialFacade.findById(Integer.parseInt(idEditorial)));
            request.getRequestDispatcher("/editorial.jsp").forward(request, response);
        }
    }
