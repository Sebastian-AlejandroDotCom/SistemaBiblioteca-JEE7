 ...
 * @author sebastian
 */
@WebServlet(name = "EliminarAutorServlet", urlPatterns = {"/eliminarAutor"})
public class EliminarAutorServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        String idAutor = request.getParameter("deleteId");
        Autor autor = autorFacade.find(Integer.parseInt(idAutor));
