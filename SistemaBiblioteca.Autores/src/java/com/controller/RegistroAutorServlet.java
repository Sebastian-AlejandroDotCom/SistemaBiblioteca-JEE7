 ...
 * @author sebastian
 */
@WebServlet(name = "RegistroAutorServlet", urlPatterns = {"/registrarAutor"})
public class RegistroAutorServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        request.getRequestDispatcher("/registroAutor.jsp").forward(request, response);
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        request.setAttribute("autores", autorFacade.findAll());
