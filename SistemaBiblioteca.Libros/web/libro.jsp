        ...
        <section id="main-content">
            <section class="wrapper">
                ...
                <section class="panel" style="background-color: #eeeeee;">
                    <div class="row">
                        <div class="col-sm-6">
                            <a class="btn btn-success" href="registrarLibro"><i class="fas fa-plus fa-lg"></i>
                                Registrar</a>
                                            ...
                                            <td>
                                                <div class="btn-group">
                                                    <a class="btn btn-primary"
                                                       href="editarLibro?editNumeroSerie=${libro.numeroSerie}"><i
                                                            class="fas fa-edit"></i></a>
                                                    <a class="btn btn-danger"
                                                       href="eliminarLibro?deleteNumeroSerie=${libro.numeroSerie}"><i
