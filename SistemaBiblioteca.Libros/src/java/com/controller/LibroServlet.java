...
public class LibroServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            request.setAttribute("msgError", "No se ha podido obtener la lista de libros: " + e.getMessage());
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (isbn == null) {
            ...
            try {
                request.setAttribute("libros", libroFacade.findByIsbn(isbn));
                request.getRequestDispatcher("/libro.jsp").forward(request, response);
            } catch (Exception e) {
                request.setAttribute("msgError", "No se ha podido obtener el libro buscado: " + e.getMessage());
                request.getRequestDispatcher("/error.jsp").forward(request, response);
            }
        }
    }
