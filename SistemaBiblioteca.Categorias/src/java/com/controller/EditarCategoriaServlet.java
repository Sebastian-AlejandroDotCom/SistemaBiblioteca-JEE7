 ...
 * @author sebastian
 */
@WebServlet(name = "EditarCategoriaServlet", urlPatterns = {"/editarCategoria"})
public class EditarCategoriaServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        String idCategoria = request.getParameter("editId");
        Categoria categoria = categoriaFacade.find(Integer.parseInt(idCategoria));
